...
void Planar2D::initPhysics(CommonCameraInterface *camera, struct GUIHelperInterface *m_guiHelper)
{
...

	{
		...
		m_physics->m_collisionShapes.push_back(colShape2);
		m_physics->m_collisionShapes.push_back(colShape3);

		m_physics->m_collisionShapes.push_back(childShape0);
		m_physics->m_collisionShapes.push_back(childShape1);
		m_physics->m_collisionShapes.push_back(childShape2);
